...
def retrieve_content(driver,draft):
    try:
        ...
        if rurl.find("monster.ca") != -1:
            ...
            element = WebDriverWait(driver, 30).until(lambda x : x.find_element_by_class_name("job-view-content-wrapper"))
            ...
            element = WebDriverWait(driver, 30).until(lambda x : x.find_element_by_class_name("jobrequirement"))
