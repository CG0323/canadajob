...
def retrieve_content(driver,draft):
    try:
        ...
        if rurl.find("monster.ca") != -1:
            ...
            element = WebDriverWait(driver, 30).until(lambda x : x.findElement(By.cssSelector(".job-view-content-wrapper.js-job-view-header-apply"))
            ...
            element = WebDriverWait(driver, 30).until(lambda x : x.findElement(By.cssSelector(".clr.section.jobrequirement"))
